...
<body>
    ...
    <section id="login-area">
        <div class="container">
                ...
                <?php
                    ...
                    if (!empty($_GET['m'])) {
                        if($_GET['m'] == 'success'){
                                ...
                                echo "<img src=./images/error.png> Subject is not registered "; 
                        }elseif ($_GET['m'] == 'tnot') {
            ...
            <form method="post" action="./PHP/update_subject.php">
                <div>
                ...
                <div>
                    ...
                    <input type="text" name="subjectName" placeholder="Enter full name of subject">
                </div>

                <div>
                    <label>Teacher Id</label>
                    <input type="text" name="teacherId" placeholder="Enter the teacher Id">
                </div>
            ...
            <section id="delete">
                ...
                <form method="post" action="add_subject.php#login-area">
